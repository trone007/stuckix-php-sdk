...
abstract class AbstractSerializer
{
	 ...
	 *
	 */
	public function __construct(int $maxDepth = 3, ?string $mbDetectOrder = null)
	{
	...
	protected function serializeString($value): string
	{
		...
		{
			$value = mb_substr($value, 0, self::MAX_VALUE_LENGTH - 10, 'UTF-8').' {clipped}';
		}
